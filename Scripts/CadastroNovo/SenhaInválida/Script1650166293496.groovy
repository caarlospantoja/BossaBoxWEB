...
try {
	...
	WebUI.setText(findTestObject('Object Repository/CadastroPage/InputField_Email'), "jcps@bossabox.com")
	WebUI.click(findTestObject('Object Repository/CadastroPage/InputField_Senha'))
	WebUI.setText(findTestObject('Object Repository/CadastroPage/InputField_Senha'), "123456")
	WebUI.click(findTestObject('Object Repository/CadastroPage/InputField_ConfirmSenha'))
	WebUI.setText(findTestObject('Object Repository/CadastroPage/InputField_ConfirmSenha'), "123456")
	...
	Assert.assertEquals("A senha deve ter pelo menos 8 caracteres", getText)
	WebUI.closeBrowser();
}catch(Exception exp) {
